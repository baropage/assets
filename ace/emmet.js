!function(e){
	var val=e();
	if("object"==typeof exports&&"undefined"!=typeof module)module.exports=val;
	if("function"==typeof define&&define.amd)define("emmet",[],val);
	{
		var f;"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self),f.emmet=val
	}
}
(function(){
	var define,module,exports;return (function outer (modules, cache, entry) {
...
define(function(require, exports, module) {
	 ...
	 * browsers. For example: op0city:0.5; ’ filter:alpha(opacity=50);<br><br>
	 *
...
define(function(require, exports, module) {
	...
	var langs = {
		...
		ru: {
			common: ['40;5:>-40;5:>', '70', 'A;>25A=K<8', '3>@0<8', '2 AB@0=5', '3;0A=KE', '8 A>3;0A=KE', '682CB', '@K1=K5', 'B5:ABK'],
			words: ['240;8', '>B 2A5E', '>=8', '1C:25==KE', '4><0E', '=0 15@53C', 'A5<0=B8:0',
				'1>;LH>3>', 'O7K:>2>3>', '>:50=0', '<0;5=L:89', '@CG55:', '40;L',
				'6C@G8B', '?> 2A59', '>15A?5G8205B', '55','2A5<8', '=5>1E>48<K<8',
				'?@028;0<8', 'MB0', '?0@0483<0B8G5A:0O', 'AB@0=0', ':>B>@>9', '60@5==K5',
				'?@54;>65=8O', '70;5B0NB', '?@O<>', '@>B', '4065', '2A5<>3CI0O',
				'?C=:BC0F8O', '=5', '8<55B', '2;0AB8', '=04', '@K1=K<8', 'B5:AB0<8',
				'254CI8<8', '157>@D>3@0D8G=K9', '>1@07', '687=8', '>4=064K', '>4=0',
				'<0;5=L:0O', 'AB@>G:0','@K1=>3>', 'B5:AB0', '8<5=8', 'lorem', 'ipsum',
				'@5H8;0', '2K9B8', '1>;LH>9', '<8@', '3@0<<0B8:8', '25;8:89', '>:A<>:A',
				'?@54C?@5640;', '>', '7;KE', '70?OBKE', '48:8E', '7=0:0E', '2>?@>A0',
				':>20@=KE', 'B>G:0E', '70?OB>9', '=>', 'B5:AB', '40;', 'A18BL',
				'A51O', 'B>;:C', '>=', 'A>1@0;', 'A5<L', 'A2>8E', '703;02=KE', '1C:2',
				'?>4?>OA0;', '8=8F80;', '70', '?>OA', '?CAB8;AO', '4>@>3C',
				'27>1@02H8AL', '?5@2CN', '25@H8=C', ':C@A82=KE', '3>@', '1@>A8;',
				'?>A;54=89', '273;O4', '=0704', 'A8;CMB', 'A2>53>', '@>4=>3>', '3>@>40',
				'1C:2>3@04', '703>;>2>:', '45@52=8', '0;D028B', '?>4703>;>2>:', 'A2>53>',
				'?5@5C;:0', '3@CAB=K9', '@5B>@8G5A:89', '2>?@>A', 'A:0B8;AO', '53>',
				'I5:5', '?@>4>;68;', 'A2>9', '?CBL', '4>@>35', '2AB@5B8;', '@C:>?8AL',
				'>=0', '?@54C?@548;0',  '<>59', '2A5', '?5@5?8AK205BAO', '=5A:>;L:>',
				'@07', '548=AB25==>5', 'GB>', '<5=O', '>AB0;>AL', 'MB>', '?@8AB02:0',
				'2>72@0I09AO', 'BK', ';CGH5', 'A2>N', '157>?0A=CN', 'AB@0=C', '?>A;CH02H8AL',
				'@C:>?8A8', '=0H', '?@>4>;68;', 'A2>9', '?CBL', '2A:>@5', '5<C',
				'?>2AB@5G0;AO', ':>20@=K9', 'A>AB028B5;L', '@5:;0<=KE', 'B5:AB>2',
				'=0?>82H89', 'O7K:><', '@5GLN', '70<0=82H89', 'A2>5', '035=BAB2>',
				':>B>@>5', '8A?>;L7>20;>', 'A=>20', 'A=>20', 'A2>8E', '?@>5:B0E',
				'5A;8', '?5@5?8A0;8', 'B>', '6825B', 'B0<', '4>', 'A8E', '?>@']
		}
	};
