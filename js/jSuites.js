/**
 * (c) jSuites Javascript Web Components (v3.4.0)
 *
        ...
        if (httpRequest.status === 200) {
            ...
            if (options.dataType == 'json') {
                try {
					...
					console.log("xxxxxxxxx httpRequest.onload error (json) xxxxxxxx", options, err);
			...
			console.log("xxxxxxxxx httpRequest.onload error xxxxxxxx", options, err);
            if (options.error && typeof(options.error) == 'function') {
